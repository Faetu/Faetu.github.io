...
date: 2024-01-02
featured_image: /retro/thm_retro_banner.png
...
![feroxbuster result](/images/posts/retro/ferox_scan.png)
...
![suspecious entry](/images/posts/retro/sus_entry.png) When I looked into the
...
{% include image_caption.html imageurl="/images/posts/retro/sysinfo.png" %}
...
To be affected, the version should be {% include badge.html
content="10.0.18362.329" %} for the file {% include badge.html
content="srv2.sys"%}. Aaaand, we are affected!

{% include image_caption.html imageurl="/images/posts/retro/srv2sys.png"
width="60%" caption="srv2.sys file on the retro machine" %}

But smbv3 seems not enabled:

{% include image_caption.html imageurl="/images/posts/retro/smbv3Disabled.png"
%}
...
With this, we get the KB number: {% include badge.html content="KB4519976" %}

{% include image_caption.html imageurl="/images/posts/retro/KBnumber.png" %}
...
{% include image_caption.html imageurl="/images/posts/retro/trash.png" %}

This is the exploit which is used for cve-2019-1388.

I found a Video which explains very good, how to do so:

<iframe src="https://cdn.embedly.com/widgets/media.html?src=https%3A%2F%2Fwww.youtube.com%2Fembed%2F3BQKpPNlTSo%3Ffeature%3Doembed&display_name=YouTube&url=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3D3BQKpPNlTSo&image=https%3A%2F%2Fi.ytimg.com%2Fvi%2F3BQKpPNlTSo%2Fhqdefault.jpg&key=a19fcc184b9711e1b4764040d3dc5c07&type=text%2Fhtml&schema=youtube" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>

I followed all the steps but there was a problem:

{% include image_caption.html imageurl="/images/posts/retro/noBrowser.png"
width="60%"%}
...
{% include image_caption.html imageurl="/images/posts/retro/FailedMS1675.png" %}
...
{% include image_caption.html imageurl="/images/posts/retro/wplogin.png" %}
...
{% include image_caption.html imageurl="/images/posts/retro/404html.png" %}
...
and use the {% include badge.html content="exploit/multi/handler" %}.

{% include image_caption.html imageurl="/images/posts/retro/meterpreter.png" %}
...
{% include image_caption.html imageurl="/images/posts/retro/noMS16.png" %}
...
{% include image_full.html imageurl="/images/posts/retro/ShouldI.png" %}
...
{% include image_caption.html imageurl="/images/posts/retro/getRoot.png" %}
