...
date: 2024-08-09
image: /assets/images/investigatingwindows3/investigations.png
tags:
  [tryhackme, writeups, windows, sysmon, sysinternals, yara, mitre, winevent]
categories: [TryHackMe, Writeup, CTF, Medium]
redirect_from: /2024/08/09/investigatingwindows3/
---
...
![Files on Desktop](/assets/images/investigatingwindows3/start_tools.png)
...
![Autoruns first look](/assets/images/investigatingwindows3/autoruns.png)
...
![Real path](/assets/images/investigatingwindows3/full_path_updater.png){: .shadow .rounded-10 }
...
![Sysmon finding on the system](/assets/images/investigatingwindows3/sysmon_found.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }

Now I create a custom view which filters for `EventID` 13:

![Custom view](/assets/images/investigatingwindows3/custom_view.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }
...
![Search debug](/assets/images/investigatingwindows3/key_name_sysmon.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }
...
![light mode only](/assets/images/investigatingwindows3/mitre_tactics_light.png){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }
![dark mode only](/assets/images/investigatingwindows3/mitre_tactics_dark.png){: .dark .w-75 .shadow .rounded-10 w='1212' h='668' }

## 4. What was UTC time for the Sysmon event?

Ye, no-brainer:

![UTC Time](/assets/images/investigatingwindows3/utc_time.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }
...
![EventType](/assets/images/investigatingwindows3/event_type.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }
...
![Get Base64 of payload](/assets/images/investigatingwindows3/get_b64_payload.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }
...
![Decoded payload](/assets/images/investigatingwindows3/service_called_payload.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }

## 7. The payload attempts to open a local port. What is the port number?

In the same file, look a bit further in the first line:

![Decoded payload port](/assets/images/investigatingwindows3/port_open_payload.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }
...
![Second decoded file](/assets/images/investigatingwindows3/second_b64.png){: .w-100 .rounded-10 w='1212' h='668' }

After that as before, the answer could be found inside the content:

![Kill process](/assets/images/investigatingwindows3/kill_process.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }

## 9. What DLL file does the payload attempt to remove?

Can be found in the same file as the previous question:

![Remove DLL](/assets/images/investigatingwindows3/remove_dll.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }
...
![Find printer](/assets/images/investigatingwindows3/find_print.png){: .w-100 .rounded-10 w='1212' h='668' }
...
![Print service id](/assets/images/investigatingwindows3/print_service_id.png){: .w-100 .rounded-10 w='1212' h='668' }

## 11. What is listed as the New Default Printer?

This one is also shown in the output before:

![Print service new default](/assets/images/investigatingwindows3/print_service_default.png){: .w-100 .rounded-10 w='1212' h='668' }

## 12. What process is associated with this event?

![Save sysmon](/assets/images/investigatingwindows3/save_sysmon_file.png){: .w-25 .rounded-10 w='1212' h='668' .right }
...
![Find associated process](/assets/images/investigatingwindows3/xpath_ualapi_dll.png){: .w-100 .rounded-10 w='1212' h='668' .right }

## 13. What is the parent PID for the above process?

I have waste to much time trying to get the answer for this by using `Get-WinEvent`. But the right answer can be found by viewing the `Logfile.PML`{: .filepath} with `Process Monitor`.

![Parent ID](/assets/images/investigatingwindows3/parent_id.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }
...
![Execute enc payload](/assets/images/investigatingwindows3/execute_enc_payload.png){: .w-100 .rounded-10 w='1212' h='668' }

## 15. Decode the payload. What is the a visible partial path?

I copy the payload from the previous question to a file named `enc.txt`{: .filepath} and decrypt it as done in question 6:
...
![decoded payload](/assets/images/investigatingwindows3/partial_path.png){: .w-100 .rounded-10 w='1212' h='668' }
...
![light mode only](/assets/images/investigatingwindows3/google_search_light.png){: .light .w-100 .rounded-10 w='1212' h='668' }
![dark mode only](/assets/images/investigatingwindows3/google_search_dark.png){: .dark .w-100 .rounded-10 w='1212' h='668' }
...
![Empire variable name](/assets/images/investigatingwindows3/empire_variable_name.png){: .w-100 .rounded-10 w='1212' h='668' }
...
The answer to this question lays in the same screenshot as the answer before. There are two other paths beside `/admin/get.php`{: .filepath}.

![Empire default paths](/assets/images/investigatingwindows3/empire_default_paths.png){: .w-100 .rounded-10 w='1212' h='668' }
...
![Destinational IP](/assets/images/investigatingwindows3/empire_dest_ip.png){: .w-100 .rounded-10 w='1212' h='668' }
...
![Other connection](/assets/images/investigatingwindows3/other_connection.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }

## 21. What is the PID for this process?

The answer is in the same output:
![Other connection](/assets/images/investigatingwindows3/other_connection_pid.png){: .w-100 .rounded-10 w='1212' h='668' }
...
![First image loaded](/assets/images/investigatingwindows3/first_image_load.png){: .w-100 .rounded-10 w='1212' h='668' }
...
![Start timespan](/assets/images/investigatingwindows3/timestamp_start.png){: .w-100 .rounded-10 w='1212' h='668' }
...
![End timespan](/assets/images/investigatingwindows3/timestamp_end.png){: .w-100 .rounded-10 w='1212' h='668' }
...
![Thread creation](/assets/images/investigatingwindows3/thread_creation.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }
...
![UTC timestamps between two proc](/assets/images/investigatingwindows3/utc_time_between.png){: .w-100 .rounded-10 w='1212' h='668' }
...
![First operation Q25](/assets/images/investigatingwindows3/first_operation_q25.png){: .w-75 .rounded-10 w='1212' h='668' }
...
![Query registry value](/assets/images/investigatingwindows3/reg_query_value.png){: .w-75 .shadow .rounded-10 w='1212' h='668' }
...
![Last module](/assets/images/investigatingwindows3/last_module.png){: .w-100 .rounded-10 w='1212' h='668' }
...
![light mode only](/assets/images/investigatingwindows3/googling_createremotethread_light.png){: .light .w-100 .rounded-10 w='1212' h='668' }
![dark mode only](/assets/images/investigatingwindows3/googling_createremotethread_dark.png){: .dark .w-100 .rounded-10 w='1212' h='668' }
