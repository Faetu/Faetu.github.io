...
![first username light](/assets/images/blockroom/light/first_username.png){: .light .shadow .w-75}
![first username dark](/assets/images/blockroom/dark/first_username.png){: .dark .shadow .w-75}
...
![server challenge light](/assets/images/blockroom/light/server_challenge.png){: .light .shadow .w-75}
![server challenge dark](/assets/images/blockroom/dark/server_challenge.png){: .dark .shadow .w-75}
...
![NTProofStr light](/assets/images/blockroom/light/ntproofstr.png){: .light .shadow .w-75}
![NTProofStr dark](/assets/images/blockroom/dark/ntproofstr.png){: .dark .shadow .w-75}
...
```
{: .nolineno}
![Bruteforce mrealman light](/assets/images/blockroom/light/bruteforce_mrealman.png){: .light .shadow .w-75}
![Bruteforce mrealman dark](/assets/images/blockroom/dark/bruteforce_mrealman.png){: .dark .shadow .w-75}
...
![Session ID light](/assets/images/blockroom/light/session_id.png){: .light .shadow .w-75}
![Session ID dark](/assets/images/blockroom/dark/session_id.png){: .dark .shadow .w-75}
...
![Encrypted Session Key light](/assets/images/blockroom/light/encrypted_session_key.png){: .shadow .w-75 .light}
![Encrypted Session Key dark](/assets/images/blockroom/dark/encrypted_session_key.png){: .shadow .w-75 .dark}
...
![Decrypt SMB2 light](/assets/images/blockroom/light/decrypt_smb2.png){: .light .w-75}
![Decrypt SMB2 dark](/assets/images/blockroom/dark/decrypt_smb2.png){: .dark .w-75}

After that I lookup all now decrypted smb3 frames. The file which contains the flag, can be found on frame 54:

![First Flag light](/assets/images/blockroom/light/first_flag.png){: .light .shadow .w-75}
![First Flag dark](/assets/images/blockroom/dark/first_flag.png){: .dark .shadow .w-75}

Or a much simpler way:


![Export files light](/assets/images/blockroom/light/export_objects.png){: .light  .w-100}
![Export files dark](/assets/images/blockroom/dark/export_objects.png){: .dark  .w-100}
...
![Second username light](/assets/images/blockroom/light/second_username.png){: .light .w-75 .shadow}
![Second username dark](/assets/images/blockroom/dark/second_username.png){: .dark .w-75 .shadow}
...
![NTLM Hash of eshellstrop light](/assets/images/blockroom/light/ntlm_hash.png){: .light .shadow .w-75}
![NTLM Hash of eshellstrop dark](/assets/images/blockroom/dark/ntlm_hash.png){: .dark .shadow .w-75}
...
![Reread article light](/assets/images/blockroom/light/reread.png){: .light .shadow .w-75}
![Reread article dark](/assets/images/blockroom/dark/reread.png){: .dark .shadow .w-75}
