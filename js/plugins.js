...
!function () {
  ...
  var s = {
    load: function (e, t) {
      ...
      n.open("GET", e, !0),
        n.onreadystatechange = (r = n, i = t, function () {
  ...
  var r = new function () {
    this.matches = function (e, t) {
      return "string" == typeof e &&
        0 <= (e = e.trim()).toLowerCase().indexOf(t.toLowerCase());
    };
  }();
  var f = {
    put: function (e) {
  ...
  function p(e, t, n, r) {
    for (var i in e) if (!d(e[i], r.exclude) && n.matches(e[i], t)) return e;
  }
  function d(e, t) {
  ...
  var h = {
      ...
      setOptions: function (e) {
        m.pattern = e.pattern || m.pattern,
          m.template = e.template || m.template,
          "function" == typeof e.middleware && (m.middleware = e.middleware);
      },
    },
    m = {};
  ...
  !function (t) {
    var r = {
      ...
      o = function e(t) {
        if (
          n = t,
            !(n && "undefined" != typeof n.required &&
              n.required instanceof Array)
    ...
    function a(e) {
      r.success(e),
        f.put(e),
        r.searchInput.addEventListener("keyup", function (e) {
          var t;
          t = e.which,
    ...
    t.SimpleJekyllSearch = function (e) {
      var n;
      return 0 < o.validate(e).length &&
        c("You must specify the following required options: " + i),
        r = y.merge(r, e),
        h.setOptions({
        ...
        y.isJSON(r.json) ? a(r.json) : (n = r.json,
          s.load(n, function (e, t) {
            e && c("failed to get JSON (" + n + ")"), a(t);
          })),
        { search: l };
    },
      t.SimpleJekyllSearch.init = t.SimpleJekyllSearch,
      "function" == typeof t.SimpleJekyllSearchInit &&
      t.SimpleJekyllSearchInit.call(this, t.SimpleJekyllSearch);
  }(window);
}();
